              ...
              <h3 class="panel-title">Students</h3>
                ...
                <c:forEach var="crs" items="${crsr.rows}">
                    ${crs.l_name} ${crs.f_name}
                                     ...
                                     <td>
                                         <a href="EditCourse.jsp?id=${items.c_id}" style="float: right;" class="btn btn-success"><span class="glyphicon glyphicon-edit"></span>Edit</a>
                                         <a href="deleteprof.jsp?id=${items.c_id}" style="float: right;" class="btn btn-danger"><span class="glyphicon glyphicon-edit"></span>Delete</a>
                                         <a href="Changecrsr.jsp?id=${items.c_id}" style="float: right;" class="btn btn-info"><span class="glyphicon glyphicon-edit"></span>Change</a>
