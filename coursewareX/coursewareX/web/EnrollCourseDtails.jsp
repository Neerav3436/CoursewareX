		...
		$(function () {
			...
			$("#jRate").jRate({
				...
				onSet: function(rating) {
                                         var sid = $('#sid').html();
                                   $.post("rate_crs.jsp",{"rate":rating ,"cid":sid}, function(d){});
...
%>
                ...
                select * from selected_courses where s_id='<%=str%>'
            </sql:query> 

            <c:forEach var="sel" items="${selected.rows}">
           
                     <sql:query var="country" dataSource="${databse}">
                select * from courseware where c_id='${sel.c_id}'
            </sql:query> 
                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header" >
                                ...
                                <div class="pull-right">  <label style="float: right;" id="s_id" class="label label-danger">${sel.s_id}</label><span class="badge badge-info"></span>
                                ...
                                <div class="row-fluid padd-bottom">
                                  ...
                                  <div class="span3">
                                   ...
                                   <div class="form-actions" >
                                       ...
                                       <label>Rate it!</label>
                                       <div id="jRate" style="height:20px;width:50px;"></div>
						...
						<div class="row">
							<div class="col-md-6">
                                                            ...
                                                            <b>Course code: </b><label id="sid">${cor.c_id}</label>
