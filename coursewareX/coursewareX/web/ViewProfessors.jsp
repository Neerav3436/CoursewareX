...
<body>
                ...
                select * from professional_register order by p_id desc
            </sql:query> 
                            ...
                            <tr>
                             ...
                             <c:forEach items="${country.rows}" var="items">
                                 <tr>
                                     ...
                                     <td>
                                         <a href="EditProfessor.jsp?id=${items.p_id}" style="float: right;" class="btn btn-success"><span class="glyphicon glyphicon-edit"></span>Edit</a>
                                         ...
                                         <a href="ViewDetails.jsp?id=${items.p_id}" style="float: right;" class="btn btn-info"><span class="glyphicon glyphicon-edit"></span>View</a>
