                            ...
                            <tr>
                             ...
                             <c:forEach items="${country.rows}" var="items">
                                 <tr>
                                     ...
                                     <td>
                                         <a href="EditStudents.jsp?id=${items.s_id}" style="float: right;" class="btn btn-success"><span class="glyphicon glyphicon-edit"></span>Edit</a>
                                     <a href="deleteclg.jsp?id=${items.s_id}" style="float: right;" class="btn btn-danger"><span class="glyphicon glyphicon-edit"></span>Delete</a>
                                     <a href="StudentViewDetails.jsp?id=${items.s_id}}" style="float: right;" class="btn btn-info"><span class="glyphicon glyphicon-edit"></span>View</a>
