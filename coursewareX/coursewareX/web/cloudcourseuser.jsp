        ...
        <div class="row-fluid">
						...
						<div class="row">
							<div class="col-md-6">
                                                            ...
                                                            <b> Course name:</b>Cloud computing<br><br>
                                                            <b>Course code: </b> 4<br><br>
                                                            <b> Duration: </b> 12 months<br><br>
                                                            <b> course fees: </b>5000 Rs<br><br>
                                                            <b>Category:</b>Conceptual/Advanced<br><br>
                                                            <b>Details: </b>Cloud computing is a recently evolved computing terminology or metaphor based on utility and consumption of computing resources. Cloud computing involves deploying groups of remote servers and software networks that allow centralized data storage and online access to computer services or resources. Clouds can be classified as public, private or hybrid.
