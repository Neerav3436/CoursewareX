        ...
        <div class="row-fluid">
						...
						<div class="row">
							<div class="col-md-6">
                                                            ...
                                                            <b> Course name:</b> Security<br><br>
                                                            <b>Course code: </b> 7<br><br>
                                                            <b> Duration: </b> 4 months<br><br>
                                                            <b> course fees: </b>2000 Rs<br><br>
                                                            <b>Category:</b> Conceptual<br><br>
                                                            <b>Details: </b> Information security, sometimes shortened to InfoSec, is the practice of defending information from unauthorized access, use, disclosure, disruption, modification, perusal, inspection, recording or destruction. It is a general term that can be used regardless of the form the data may take (e.g. electronic, physical). IT security specialists are almost always found in any major enterprise/establishment due to the nature and value of the data within larger businesses. They are responsible for keeping all of the technology within the company secure from malicious cyber attacks that often attempt to breach into critical private information or gain control of the internal systems.
