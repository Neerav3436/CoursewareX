...
<html>
    ...
    %>
      ...
      <sql:query dataSource="${dataSource}" var="data" >
        select * from student_register where u_name = 'neera'
    </sql:query>
        
        
        <c:forEach var="data" items="${data.rows}">
            <input type="text" value="${data.f_name}"  readonly/>
            ${data.state}
        </c:forEach>
...
<!--        
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8">
                    <h1>Welcome to Student Panels</h1>
                </div>
            </div>
        </div>
    </header>-->
      ...
      <div class="span3 bs-docs-sidebar">
        <ul class="nav nav-list bs-docs-sidenav">
            <li><a href="#tables"><i class="icon-chevron-right"></i>Getting Start!</a></li>
